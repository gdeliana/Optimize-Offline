...
- DisableWindowsUpdateMicrosoft - Applies the official Microsoft solution to prevent Windows Update from connecting to Microsoft's update services. By design, this includes disallowing connects to the Windows Store to download in-box modern apps. [Microsoft Document] (https://docs.microsoft.com/en-us/windows/privacy/manage-connections-from-windows-operating-system-components-to-microsoft-services#bkmk-wu) Once installed, you can switch between allowing and disallowing the connection to Microsoft's update services by using a toggle script [GitHub Gist] (https://gist.github.com/espanafly/3041ce74cd2493d349e58c31630f98e5)
- DisableDriverUpdate - Will disable windows update from updating hw drivers
- DormantOneDrive - Disables the startup installation of OneDrive leaving the setup file intact, but fully dormant. You are free to manually install OneDrive at your convenience
